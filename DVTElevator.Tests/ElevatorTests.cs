...
namespace DVTElevator.Tests
{
    ...
    {
        [Fact]
        public void AddPassenger_WithCapacity_IncreasesPassengerCount()
        {
        ...
        [Fact]
        public void AddPassenger_ExceedingCapacity_ThrowsInvalidOperationException()
        {
            ...
            act.Should().Throw<InvalidOperationException>().WithMessage("Elevator overloaded.");
        }
        ...
        public void SetPassengerFloor_SetsCorrectDirection(int currentFloor, int passengerFloor, Direction expected)
        {
